...
class _EditarPerfilState extends State<EditarPerfil> {
  ...
  void initState() {
    super.initState();
    nombre.text = persona_nombre;
    apellido.text = persona_apellido;
    direccion.text = persona_direccion;
    telefono.text = persona_telefono;
    correo.text = persona_correo;
    usuario.text = persona_usuario;
    if (persona_imagen == "") {
      persona_imagen =no_foto;
    }
  }
                                ...
                                if (nombre.text != "" &&
                                    ...
                                    password.text != "") {
                                      ...
                                      if(validar_correo == true){
                                        ...
                                        controller_persona.editar_perfil(
                                      persona_id,
                                      nombre.text,
                                      apellido.text,
                                      direccion.text,
