...
class IngresarTipoInmueble extends StatefulWidget {
  @override
  _IngresarTipoInmuebleState createState() => new _IngresarTipoInmuebleState();
}

class _IngresarTipoInmuebleState extends State<IngresarTipoInmueble> {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Text("Nombre del tipo del inmueble",
                style: TextStyle(
            ...
            TextField(
              ...
              decoration: InputDecoration(
                  hintText: "Ingrese el nombre del tipo de inmueble",
                  hintStyle: TextStyle(color: Colors.grey, fontSize: 12.0)),
            ),
            SizedBox(
              height: ScreenUtil.getInstance().setHeight(30),
            ),
            Text("Descripcion del tipo del inmueble",
                style: TextStyle(
                    fontFamily: "Poppins-Medium",
                    fontSize: ScreenUtil.getInstance().setSp(26))),
            TextField(
              ...
              decoration: InputDecoration(
                  hintText: "Ingrese el descripcion del tipo de inmueble",
                  hintStyle: TextStyle(color: Colors.grey, fontSize: 12.0)),
            ),
            SizedBox(
              height: ScreenUtil.getInstance().setHeight(30),
                              ...
                              onTap: () {
                                if (nombre.text != "" &&
                                  ...
                                  controller_tipo_inmueble
                                      .ingresar_tipo_inmueble(nombre.text,
                                          _image, descripcion.text, context);
                                } else {
                                  aviso(
